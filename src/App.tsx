...
const PROJECTS: Project[] = [
  ...
  {
    title: 'StreetWear KE',
    description: 'E-commerce storefront for a Nairobi streetwear label. Limited-drop catalogue, bold dark-mode design, and WhatsApp-based ordering built for mobile-first shoppers.',
