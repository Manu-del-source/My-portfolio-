...
const PROJECTS: Project[] = [
  ...
  {
    title: 'Phikila',
    image: '/images/projects/phikila.png',
    description: 'All-in-one school operations platform for African schools. Student records, academics, timetables, attendance, finance, and reporting unified in a single clear operating system — live at phikila.com.',
    tags: ['Next.js', 'React', 'Supabase', 'PostgreSQL', 'TypeScript', 'Tailwind'],
    badge: 'Live',
    badgeColor: 'green',
    link: 'https://phikila.com',
    icon: '🎓',
  },
  {
    title: 'StreetWear KE',
